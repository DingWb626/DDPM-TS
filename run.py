...
fix_seed = 2024               #设定一个固定的随机种子值 2024
random.seed(fix_seed)         #设置Python 内置的随机数生成器的种子
torch.manual_seed(fix_seed)   #设定 PyTorch 的随机种子
np.random.seed(fix_seed)      #固定 NumPy 的随机数种子
