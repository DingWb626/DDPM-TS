...
mimic_data_dir = 'D:\\PycharmProjects\\DDPM-TS\\datasets\\MIMICIII\\'
...
ch = []
for chunk in tqdm(pd.read_csv(mimic_data_dir+'CHARTEVENTS.csv', chunksize=100000,low_memory = True,
...
# Save data.
events.to_csv('D:\\PycharmProjects\\DDPM-TS\\datasets\\MIMICIII\\mimic_iii_events.csv', index=False)
icu.to_csv('D:\\PycharmProjects\\DDPM-TS\\datasets\\MIMICIII\\mimic_iii_icu.csv', index=False)

#data/mimic_iii_icu.csv
